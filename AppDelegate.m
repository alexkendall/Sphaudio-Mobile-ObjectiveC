...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UITabBarController *tab_controller = [[UITabBarController alloc]init];
    ...
    [tab_controller.tabBar setBackgroundColor:[UIColor blackColor]];
    [tab_controller.tabBar setTranslucent:NO];
    tab_controller.tabBar.backgroundColor = [UIColor blackColor];
    tab_controller.tabBar.barStyle = UIBarStyleBlack;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.alexkendall.Practice" in the application's documents directory.
